...
# List of base URLs
base_urls = [
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-new-cairo/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-zamalek/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-maadi/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-madinaty/'
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-mostakbal-city/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-new-capital-city/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-shorouk-city/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-nasr-city/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-heliopolis/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-new-heliopolis/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-katameya/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-mokattam/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-sheraton/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-zahraa-al-maadi/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-el-fostat/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-badr-city/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-obour-city/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-masr-al-kadema/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-downtown-cairo/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-new-nozha/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-al-manial/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-garden-city/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-qasr-al-nil/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-helmeyat-el-zaytoun/',
    # 'https://www.bayut.eg/en/cairo/properties-for-sale-in-almazah/'
...
for base_url in base_urls:
    new_data = scrape_all_pages(base_url, max_pages=1)
    all_new_data.extend(new_data)

# Update Excel with all new data
update_excel_with_new_data('sale_bayut.xlsx', all_new_data)

print("Scraping complete. Data updated in sale_bayut.xlsx.")
